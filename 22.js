import { firstName, lastName, year, multiply, } from './22-profile'; // 与接口提供的名字要一致 一一罗列
...
import  * as circleAS from './22-circle'; // 整体加载   ＊ 指定一个对象(可以任意取名的)
...
import exportDefaultFunFoo2 from  './22-export-default-2';
import exportDefaultFunFoo3 from  './22-export-default-3';
console.log(exportDefaultFun(), exportDefaultFunFoo2(), exportDefaultFunFoo3());
